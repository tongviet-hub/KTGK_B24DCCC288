...
export default function App() {
  ...
  function handleCreate(data: Omit<Post, "id" | "date">) {
    setPosts([{ ...data, id: Date.now(), date: new Date().toISOString().slice(0, 10) }, ...posts]);
  }
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/posts" element={<Home posts={posts} onDelete={handleDelete} />} />
        ...
        <Route path="/posts/edit/:id" element={<EditPost posts={posts} onUpdate={handleUpdate} />} />
      </Routes>
    </BrowserRouter>
  );
}
